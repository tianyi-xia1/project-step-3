...
def main():
    try:
        ...
        if not word_pairs:
            raise ValueError("No word pairs found. Please ensure the word pairs are initialized properly.")
        ...
        while not exit_program:
            ...
            if not session_word_pairs:
                print(f"No word pairs found for the '{selected_difficulty}' difficulty level.")
                continue
